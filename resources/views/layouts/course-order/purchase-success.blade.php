        ...
        @if (session('free-course'))
           <div class="row">
            <div class="col-xs-12 col-md-8 col-md-offset-2 text-center">
                ...
                <h4>Kelas ini GRATIS. Namun, kamu harus share postingan facebook Pintaar. Jika sudah, kelas dapat kamu akses dalam 1x24 jam.</h4>
                <br>
        ...
        @else
           <div class="row">
              <div class="col-xs-12 col-md-8 col-md-offset-2 text-center">
                ...
                <a href="{{ route('courses-category', 1) }}" class="btn btn-primary btn-lg">Beli Kelas Lagi</a>  
              </div>
            </div>
        @endif
    </div>
