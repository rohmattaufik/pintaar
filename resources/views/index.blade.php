        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ URL::asset('images/service-icon-1.png') }}" alt="">
                        </div>
                        <h4>EASY TO USE</h4>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ URL::asset('images/service-icon-2.png') }}" alt="">
                        </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ URL::asset('images/service-icon-3.png') }}" alt="">
                        </div>
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="item row">
                                <div class="v-center">
                                    ...
                                    <div class="col-xs-6 col-md-3">
                                        <div class="caption-photo one" data-animation="animated fadeInRight">
                                            <img src="{{ URL::asset('images/screen-7.jpg') }}" alt="">
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-md-3">
                                        <div class="caption-photo two" data-animation="animated fadeInRight">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ URL::asset('images/portfolio-icon-1.png') }}" alt="">
                        </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ URL::asset('images/portfolio-icon-2.png') }}" alt="">
                        </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ URL::asset('images/portfolio-icon-3.png') }}" alt="">
                        </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ URL::asset('images/portfolio-icon-4.png') }}" alt="">
                        </div>
                        <h3>Retina ready</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque quas nulla est adipisci,</p>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ URL::asset('images/portfolio-icon-5.png') }}" alt="">
                        </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="box">
                        <div class="box-icon">
                            <img src="{{ URL::asset('images/portfolio-icon-6.png') }}" alt="">
                        </div>
                        <h3>Clean Codes</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque quas nulla est adipisci,</p>
                    </div>
                    ...
                    <div class="testimonials">
                        <div class="testimonial">
                            <div class="testimonial-photo">
                                <img src="{{ URL::asset('images/avatar-small-1.png') }}" alt="">
                            </div>
                            <h3>AR Rahman</h3>
                        ...
                        <div class="testimonial">
                            <div class="testimonial-photo">
                                <img src="{{ URL::asset('images/avatar-small-3.png') }}" alt="">
                            </div>
                            <h3>AR Rahman</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel vero dolore officiis, velit id libero illum harum hic magni, quae repellendus adipisci possimus saepe nostrum doloribus repudiandae asperiores commodi voluptate.</p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial-photo">
                                <img src="{{ URL::asset('images/avatar-small-4.png') }}" alt="">
                            </div>
                            <h3>AR Rahman</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel vero dolore officiis, velit id libero illum harum hic magni, quae repellendus adipisci possimus saepe nostrum doloribus repudiandae asperiores commodi voluptate.</p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial-photo">
                                <img src="{{ URL::asset('images/avatar-small-5.png') }}" alt="">
                            </div>
                            <h3>AR Rahman</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel vero dolore officiis, velit id libero illum harum hic magni, quae repellendus adipisci possimus saepe nostrum doloribus repudiandae asperiores commodi voluptate.</p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial-photo">
                                <img src="{{ URL::asset('images/avatar-small-6.png') }}" alt="">
                            </div>
                            <h3>AR Rahman</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vel vero dolore officiis, velit id libero illum harum hic magni, quae repellendus adipisci possimus saepe nostrum doloribus repudiandae asperiores commodi voluptate.</p>
                        </div>
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-xs-12">
                    <div class="clients">
                        <div class="item">
                            <img src="{{ URL::asset('images/themeforest.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ URL::asset('images/coadcanyon.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ URL::asset('images/graphicriver.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ URL::asset('images/docean.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ URL::asset('images/audiojungle.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ URL::asset('images/actividen.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ URL::asset('images/photodone.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ URL::asset('images/videgub.gif') }}" alt="">
                        </div>
                        <div class="item">
                            <img src="{{ URL::asset('images/themeforest.gif') }}" alt="">
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="single-blog">
                        <div class="blog-photo">
                            <img src="{{ URL::asset('images/small2.jpg') }}" alt="">
                        </div>
                        <div class="blog-content">
                            <h3><a href="#">Beautiful Place for your Great Journey</a></h3>
                            <ul class="blog-meta">
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="single-blog">
                        <div class="blog-photo">
                            <img src="{{ URL::asset('images/small3.jpg') }}" alt="">
                        </div>
                        <div class="blog-content">
                            <h3><a href="#">Beautiful Place for your Great Journey</a></h3>
                            <ul class="blog-meta">
